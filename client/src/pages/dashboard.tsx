  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <Header title="ATMF Insight Navigator" />
        
        <div className="flex-1 overflow-y-auto p-6">
          {/* Dashboard Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-heading font-bold mb-2">ATMF Dashboard</h1>
            <p className="text-text-muted">Track and improve your testing maturity across all dimensions</p>
          </div>
